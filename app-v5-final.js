    ...
    async showSpotDetail(spotId) {
        ...
        content.innerHTML = `
            ...
            <div class="detail-section">
                <h3>🌊 浪况分析 (${(scores.waveScore || 0).toFixed(1)}/10)</h3>
            ...
            <div class="detail-section">
                <h3>💨 风况分析 (${(scores.windScore || 0).toFixed(1)}/10)</h3>
                <div class="detail-grid">
                    <div class="detail-item">
            ...
            <div class="detail-section">
                <h3>🌊 潮汐分析 (${(scores.tideScore || 0).toFixed(1)}/10)</h3>
                <div class="detail-grid">
                    <div class="detail-item">
            ...
            <div class="detail-section">
                ...
                <div class="final-summary">
                    <strong>总结:</strong> ${suggestion.summary || '数据分析中...'}
                </div>
            </div>
        `;
